...
class TMCloudIntegratedSearch:
    ...
    # 審査中間処分コードマッピング（整理標準化データ 準拠）
INTERMEDIATE_DISPOSITION_MAP = {
    "Ａ００７１": "中断",
    "Ａ００７２": "中断解除",
    "Ａ０１": "特許査定／登録査定",
    "Ａ０１１": "書換登録査定",
...
REGISTRATION_INTERMEDIATE_CODE_MAP = {
    ...
    "60": "条文なし",
    "61": "第6条1項",
    "62": "第6条1項（防護） 又は 第6条2項(防護)",
    "63": "第6条1項＋第6条2項",
    "64": "第64条 （防護）",
    "65": "第6条1項（防護）＋第6条2項（防護）",
    "66": "第6条1項 又は 第6条2項",
    "67": "第6条1項（防護）",
    "68": "防護更新",
    "69": "第6条2項",
    ...
    "80": "附則第6条2項（住所相違）",
    "81": "附則第6条2項（氏名及び住所相違）",
    "82": "第3条柱書＋第8条1項＋第4条1項11号",
    "83": "第3条各号＋第8条1項＋第4条1項11号",
    "84": "第4条各号＋第8条1項＋第4条1項11号",
    "85": "その他＋第8条1項＋第4条1項11号",
    "92": "第3条柱書＋その他（第4条1項11号を除く）",
    "93": "第3条各号＋その他（第4条1項11号を除く）",
    "94": "第4条各号＋その他（第4条1項11号を除く）",
    "95": "その他（第4条1項11号を除く）",
}
        ...
        if unified_format:
            ...
            for r in final_results:
                formatted = {
                    ...
                    'rejection_reason_codes': [
                        f"{r['rejection_reason_code']}: {self.REJECTION_REASON_CODES.get(r['rejection_reason_code'], '')}"
                    ] if r.get('rejection_reason_code') else [],
    ...
    def search_complex(self, conditions: List[Dict[str, Any]], operator: str = 'AND', limit: int = 100, unified_format: bool = True) -> List[Dict[str, Any]]:
        ...
        for cond in conditions:
            ...
            if search_type == 'trademark':
                ...
                # 拒絶条文コード検索
                results = self.search_rejection_reason(keyword, limit=10000, unified_format=False)
            else:
                continue
