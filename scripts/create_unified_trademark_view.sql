...
-- 統合検索用インデックス作成（ビューには直接作成できないため、実際のテーブルで必要）
-- CREATE INDEX IF NOT EXISTS idx_unified_trademark_text ON unified_trademark_search_view(trademark_text);
-- CREATE INDEX IF NOT EXISTS idx_unified_pronunciation ON unified_trademark_search_view(pronunciation);
-- CREATE INDEX IF NOT EXISTS idx_unified_nice_classes ON unified_trademark_search_view(nice_classes);
-- CREATE INDEX IF NOT EXISTS idx_unified_holder_name ON unified_trademark_search_view(holder_name);